---
description: |
   Use this agent when the user asks for help with complex architectural decisions, system design, or strategic technical challenges that require senior-level expertise.
